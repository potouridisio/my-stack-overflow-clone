...
export const useIsIgnoredStore = create((set) => ({
  isIgnoredTag: false,
  setIsIgnoredTag: (isIgnoredTag) => set({ isIgnoredTag }),
}));
...
export const useSelectedRadioButton = create((set) => ({
  selectedRadioButton: "Gray out questions in your ignored tags",
...
export default function IgnoredTags({ tags }) {
  ...
  const { isIgnoredTag, setIsIgnoredTag } = useIsIgnoredStore();
